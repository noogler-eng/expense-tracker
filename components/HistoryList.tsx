...
export default function HistoryList({
 ...
 {/* Share All Button */}
 <View style={{ borderBottomColor: t.border }} className="flex flex-row gap-4 px-6 py-4 border-b mb-4 justify-center">
 <TouchableOpacity
 ...
 delay={index * 60}
 duration={400}
 style={cardStyle} className="rounded-xl px-6 py-5 mb-4"
 >
 ...
 <Text style={{ color: t.textMuted }} className="text-xs font-medium border-b border-neutral-700 pb-1">
