...
export default function FriendList(props: {
 ...
 <Text style={{ color: t.textMuted }} className="text-sm mt-2 text-center">
 ...
 duration={500}
 >
 <View style={cardStyle} className="flex-row items-center justify-between px-4 py-3 rounded-2xl">
