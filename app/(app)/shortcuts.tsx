...
export default function Shortcuts() {
 ...
 setCategory("food");
 load();
 toast.show(`"${label.trim()}" shortcut created.`);
 };
 ...
 {/* Header */}
 <View className="mb-6">
 <Text style={{ color: t.text }} className="text-3xl font-bold">Quick Add</Text>
 ...
 <Text style={{ color: t.textSecondary }} className="text-xs mb-1 ml-1">Label</Text>
 <TextInput
 value={label}
 ...
 <View>
 <Text style={{ color: t.text }} className="font-medium">{item.label}</Text>
