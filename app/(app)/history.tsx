...
export default function History() {
 ...
 <Text style={{ color: t.text }} className="text-3xl font-bold mb-2">History</Text>
 <Text style={{ color: t.textSecondary }} className="text-sm mb-6">
 ...
 activeOpacity={0.85}
 style={cardStyle} className="flex-row items-center justify-between px-4 py-4 rounded-2xl mb-3"
 >
 {/* Left */}
