...
export default function SplitBill() {
 ...
 setCategory("others");
 loadFriends();
 toast.show("Bill split among ${splitTxnDetails.ids.length} friends.");
 } catch (error) {
 ...
 return (
 <View style={{ backgroundColor: t.bg }} className="flex-1 px-6">
 {/* Header */}
 <View className="mb-6">
 <Text style={{ color: t.text }} className="text-3xl font-bold">Split Bill</Text>
 ...
 {/* Amount */}
 <Text style={{ color: t.textMuted }} className="text-xs uppercase tracking-widest mt-4 mb-2">
 Total Amount
 </Text>
 <TextInput
 value={amount}
 ...
 <Text style={{ color: t.textMuted }} className="text-xs mb-6">
