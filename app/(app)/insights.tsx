...
export default function Insights() {
 ...
 <View className="mb-6">
 <Text style={{ color: t.text }} className="text-3xl font-bold">Insights</Text>
 <Text style={{ color: t.textSecondary }} className="text-sm mt-1">Your spending patterns</Text>
 </View>
 ...
 <Text style={{ color: t.text }} className="text-5xl font-bold mt-3">{streak}</Text>
 <Text style={{ color: t.textSecondary }} className="text-sm mt-1">day streak</Text>
 <Text style={{ color: t.textMuted }} className="text-xs mt-2 text-center">
 ...
 <Text style={{ color: t.text }} className="text-xl font-semibold mb-3">Top Spending Days</Text>
 ...
 <Text style={{ color: t.text }} className="text-xl font-semibold mb-3">Category Trends</Text>
 <Text style={{ color: t.textMuted }} className="text-xs mb-3">Last 4 weeks</Text>

 {categoryTrends.map((item) => (
 <View key={item.cat} style={cardStyle} className="rounded-2xl rounded-2xl p-4 mb-3">
