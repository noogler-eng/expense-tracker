  ...
  return (
    <ScrollView className="flex-1 bg-[#0B0B0D] px-6 pt-4">
      <View className="mb-6">
        ...
        <Text className="text-neutral-400 text-sm mt-1">Set monthly spending limits</Text>
      </View>
            ...
            <View className="bg-[#0F0F12] border border-neutral-800 rounded-2xl p-4">
              ...
              <View className="flex-row justify-between items-center">
                <Text className="text-neutral-500 text-xs">
                  Spent: <Text className="text-white font-semibold">₹{spent.toFixed(0)}</Text>
              ...
              {/* Budget input */}
              <View className="mt-3">
                <Text className="text-neutral-400 text-xs mb-1">Monthly limit</Text>
                <TextInput
