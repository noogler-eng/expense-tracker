...
export default function AddExpense() {
 ...
 setCategory("others");
 toast.show("Expense recorded successfully.");
 } catch {
 ...
 {/* Header */}
 <View className="mb-8">
 <Text style={{ color: t.text }} className="text-3xl font-bold">Add Expense</Text>
 ...
 >
 <Text style={{ color: t.text }} className="font-semibold text-base">
 {item.firstName[0]}
 {item.lastName[0]}
 </Text>
 </View>
 ...
 <Text style={{ color: t.textMuted }} className="text-xs mb-8">
